	...
	return (
		<div className="bg-taskCard-neutral mb-2 mx-auto max-w-md rounded-b-md">
			...
			<div className="flex justify-between">
				...
				{/* Button */}
				<div>
					<button className="bg-taskCard-project text-sm pl-2 pr-2 p-1 rounded-[3px] hover:bg-taskCard-projectDarker transition-all duration-400 hover:text-gray-200 mr-2 mb-2 shadow-md shadow-taskCard-project/50 hover:shadow-inner">
						Добавить
					</button>
				</div>
			</div>
